...
<html lang="en">
	<head>
		...
		function catchcollect() 
		{	
			$.ajax(
			{
				url: "catchcollect.php",
				type: "POST",
				datatype: "html",
				success: function( output ) 
				{
		...
		window.addEventListener( "load",catchcollect, false );
...
 			function youtubefind(target)
				...
				$.ajax(
			{
				...
				$("html, body").animate({scrollTop: $('#videobox').offset().top}, 50, 'swing');
			}
		...
		<script>
			...
			{
				document.getElementById( "collect1" ).addEventListener(
					"click", function() { collectfind( "1" ); }, false );
				document.getElementById( "collect2" ).addEventListener(
					"click", function() { collectfind( "2" ); }, false );
				document.getElementById( "collect3" ).addEventListener(
					"click", function() { collectfind( "3" ); }, false );
				document.getElementById( "collect3" ).addEventListener(
					"click", function() { collectfind( "3" ); }, false );
				document.getElementById( "collect4" ).addEventListener(
					"click", function() { collectfind( "4" ); }, false );
				document.getElementById( "collect5" ).addEventListener(
					"click", function() { collectfind( "5" ); }, false );
				document.getElementById( "collect6" ).addEventListener(
					"click", function() { collectfind( "6" ); }, false );
				document.getElementById( "collect7" ).addEventListener(
					"click", function() { collectfind( "7" ); }, false );
				document.getElementById( "collect8" ).addEventListener(
					"click", function() { collectfind( "8" ); }, false );
				document.getElementById( "collect9" ).addEventListener(
					"click", function() { collectfind( "9" ); }, false );
				document.getElementById( "collect10" ).addEventListener(
					"click", function() { collectfind( "10" ); }, false );
				document.getElementById( "collect11" ).addEventListener(
					"click", function() { collectfind( "11" ); }, false );
				document.getElementById( "collect12" ).addEventListener(
					"click", function() { collectfind( "12" ); }, false );
				document.getElementById( "collect13" ).addEventListener(
					"click", function() { collectfind( "13" ); }, false );
				document.getElementById( "collect14" ).addEventListener(
					"click", function() { collectfind( "14" ); }, false );
				document.getElementById( "collect15" ).addEventListener(
					"click", function() { collectfind( "15" ); }, false );
				
			}
			function collectfind(target)
			{
				$.ajax(
			{
				url: "collectmainvideo.php",
				data: 
				{
					target: target
				},
	...
	<body style="background-color:#d6d5db;">
		<nav class="navbar navbar-dark bg-dark navbar-expand-lg navbar-light bg-light">
			...
			<div class="collapse navbar-collapse" id="navbarTogglerDemo01">
				...
				<ul class="navbar-nav mr-auto mt-2 mt-lg-0">
					...
					<li class="nav-item">
						<a class="nav-link" href="addvideo.php">點我新增影片</a>
					</li>
		...
		<div class="accordion" id="accordionExample" style="margin:40px 20px 20px">
			...
			<div class="card" id="target">
				...
				<div id="collapseFour" class="collapse" aria-labelledby="collect" data-parent="#accordionExample">
					<p class="card-text" style="margin:5px;text-align:right ">點擊方格即可觀看 </p>
					<div id ="collect"></div>
				</div>
			</div>
